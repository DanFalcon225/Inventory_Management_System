    ...
    $("#productImage").fileinput({
      overwriteInitial: true,
        ...
        $("#submitProductForm").unbind('submit').bind('submit', function(){
          ...
          if(productImage && productName && quantity && rate && brandName && categoryName && productStatus && supplierName){
	...
	if(productId) {
        ...
        // supplier name
          ...
          if(supplierName == "") {
					...
					if(productName && quantity && rate && brandName && categoryName && supplierName && productStatus) {
						// submit loading button
