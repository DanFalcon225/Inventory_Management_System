	...
	if(orderId) {
		...
		$.ajax({
			...
			success:function(response) {				
				...
				// due 
				$("#due").val(response.orders[10]);				

				// pay amount 
				$("#payAmount").val(response.orders[10]);

				var paidAmount = response.orders[9] 
				var dueAmount = response.orders[10];							
				var grandTotal = response.orders[8];
