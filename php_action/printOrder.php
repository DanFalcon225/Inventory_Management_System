...
$orderItemSql = "SELECT orders_items.product_id, orders_items.rate, orders_items.quantity, orders_items.total,
products.product_name FROM orders_items
	INNER JOIN products ON orders_items.product_id = products.product_id 
