			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:20px;">
			  					...
			  					<select class="form-control" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
			  						...
			  						<?php
			  							$productSql = "SELECT * FROM products WHERE active = 1 AND status = 1 AND quantity != 0";
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <table class="table" id="productTable">
			  	...
			  	<tbody>
			  		...
			  		$orderItemSql = "SELECT orders_items.orders_item_id, orders_items.order_id, orders_items.product_id, orders_items.quantity, orders_items.rate, orders_items.total FROM orders_items WHERE orders_items.order_id = {$orderId}";
